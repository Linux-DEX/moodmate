...
import 'package:moodmate/reusable_widgets/comment_card.dart';
      ...
      bottomNavigationBar: SafeArea(
        child: Container(
          ...
          child: Row(children: [
            ...
            InkWell(
              onTap: ()async{
                await FirestoreMethods().postComment(widget.snap['postId'], _commentContoller.text, user.uid, user.username, user.photoUrl);
                setState(() {
